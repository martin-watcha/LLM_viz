    ...
    substeps: [
        ...
        data: {
          ...
          paramGroups: [
            ...
            { label: "Encoder Self-Attention", matrices: [
              { data: MODEL_PARAMS.Wq_e, label: <>W<sub>q_e</sub> (2×2)</> },
              { data: MODEL_PARAMS.Wk_e, label: <>W<sub>k_e</sub> (2×2)</> },
              { data: MODEL_PARAMS.Wv_e, label: <>W<sub>v_e</sub> (2×2)</> },
            ]},
            { label: <>Encoder FFN (d<sub>ff</sub>=4)</>, matrices: [
              { data: MODEL_PARAMS.W1_e, label: <>W<sub>1_e</sub> (2×4)</> },
              { data: MODEL_PARAMS.W2_e, label: <>W<sub>2_e</sub> (4×2)</> },
            ]},
          ],
        },
      ...
      },
      {
        ...
        data: {
          ...
          inputLabel: <>Enc<sub>attn_out</sub> (3×2)</>, weightLabel: <>W<sub>1_e</sub> (2×4)</>,
        },
        formula: <span>h = ReLU(Enc<sub>attn_out</sub> · W<sub>1_e</sub>)</span>,
      },
      {
        id: "p0_s11", type: "matmul_mm",
        title: <>⑩ FFN Layer 2: h · W<sub>2_e</sub> = Enc<sub>out</sub></>,
        desc: "ReLU 출력을 두 번째 층에 통과 → Encoder 최종 출력",
        data: { left: ENC_FFN_POST, right: MODEL_PARAMS.W2_e, result: ENC_OUT,
                leftLabel: "hidden (3×4)", rightLabel: <>W<sub>2_e</sub> (4×2)</>, resultLabel: <>Enc<sub>out</sub> (3×2)</> },
        ...
        data: {
          ...
          paramGroups: [
            { label: "Decoder Masked Self-Attention", matrices: [
              { data: MODEL_PARAMS.Wq_d, label: <>W<sub>q_d</sub> (2×2)</> },
              { data: MODEL_PARAMS.Wk_d, label: <>W<sub>k_d</sub> (2×2)</> },
              { data: MODEL_PARAMS.Wv_d, label: <>W<sub>v_d</sub> (2×2)</> },
            ]},
            { label: "Cross-Attention", matrices: [
              { data: MODEL_PARAMS.Wq_c, label: <>W<sub>q_c</sub> (2×2)</> },
              { data: MODEL_PARAMS.Wk_c, label: <>W<sub>k_c</sub> (2×2)</> },
              { data: MODEL_PARAMS.Wv_c, label: <>W<sub>v_c</sub> (2×2)</> },
            ]},
            { label: <>Decoder FFN (d<sub>ff</sub>=4)</>, matrices: [
              { data: MODEL_PARAMS.W1_d, label: <>W<sub>1_d</sub> (2×4)</> },
              { data: MODEL_PARAMS.W2_d, label: <>W<sub>2_d</sub> (4×2)</> },
            ]},
            { label: "Output Projection", matrices: [
              { data: MODEL_PARAMS.Wo, label: <>W<sub>o</sub> (5×2)</> },
            ]},
          ],
        },
